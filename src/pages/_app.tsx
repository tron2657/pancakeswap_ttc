  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Cheaper and faster than Uniswap? Discover TTCSwap, the leading DEX on BNB Smart Chain (BSC) with the best farms in DeFi and a lottery for CAKE."
        />
        <meta name="theme-color" content="#1FC7D4" />
        <meta name="twitter:image" content="https://ttcswap.finance/images/ttc_hero.jpg" />
        <meta
        ...
        <meta name="twitter:title" content="🥞 TTCSwap - A next evolution DeFi exchange on BNB Smart Chain (BSC)" />
        <title>TTCSwap</title>
      </Head>
